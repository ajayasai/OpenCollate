...
def _capability_data() -> dict[str, Any]:
    ...
    return {
        ...
        "sequential_verification": {
            ...
            "elaborated_hierarchy": True,
            "property_cone_reduction": True,
            "always_comb": "definitely-assigned-whole-signals",
            "case_statements": "ordinary-first-match",
            "integral_enums": True,
            "manifest_preprocessing": "explicit-headers-and-defines",
            "preprocessing_compilation_unit": "single-ordered",
            "computed_includes": False,
