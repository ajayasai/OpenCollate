...
[Report a vulnerability](https://github.com/ajayasai/OpenCollate/security/advisories/new) form.
Begin the title with **[Conduct]**. Conduct reports sent through this private channel are handled
as conduct reports, not as vulnerability reports. Do not open a public issue.

All complaints will be reviewed and investigated promptly and fairly. Community leaders are
obligated to respect the privacy and security of the reporter. If the private form is unavailable
or the report concerns the repository owner, contact
[GitHub Support](https://support.github.com/contact/report-abuse) for platform-hosted conduct.
...
from the [Contributor Covenant](https://www.contributor-covenant.org/translations).
